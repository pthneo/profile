...
const projects = [
  ...
  {
    title: "UQ Football Society Website & eCommerce Store",
    image: "/uqf.png",
    description: "Constructed a website for a university society, using WordPress and Elementor with a PayPal integration for booking tickets for events, QPay for managing memberships, and live social media feeds with Instagram and Facebook. ",
  ...
  },
  {
    ...
    image: "/morgana.png",
    tech: ["Next.js", "React", "Tailwind CSS", "Drizzle ORM", "PostgreSQL", "OAuth", "Nodemailer", "TOTP", "Docker", "Stripe"],
    progress: 20,
  },
  {
    title: "Merit Web Application",
    image: "/merit.png",
    description: "For a university project, created a web application using Next.js, React and Supabase for a digital loyalty card system. Business owners could manage their business’ profile using the web application, and I constructed a mobile app using React Native for consumers of the loyalty cards to use. The React Native app implemented features such as QR code scanning and location tracking.",
...
export default function LatestWorks() {
  ...
  return (
    <div className="h-full pb-12 pt-6">
      <Slider
        {...settings}
        className="h-full rounded-2xl border shadow-md  dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-none overflow-auto">
